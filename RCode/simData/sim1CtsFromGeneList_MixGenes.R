...
geneListMat=read_delim("C:/Sean/UNC/Mike Love/GTEx/PaperReproduce/data/geneLists/sim_BrainMix.txt",delim="\t")
...
geneListAlpha=unlist(tissueAlphaRed[,3]*geneListOrder$Tissue+tissueAlphaRed[,ncol(tissueAlphaRed)]*(1-geneListOrder$Tissue))
modelAlpha=data.frame(tissueAlphaRed[,1:2],matrix(rep(geneListAlpha,nSamp ),ncol=nSamp)  )
...
write_delim(outIso,"C:/Sean/UNC/Mike Love/GTEx/PaperReproduce/data/simData/sim_BrainMix_Counts.txt",delim="\t")
